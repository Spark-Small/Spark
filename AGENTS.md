...
5. [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — layers, navigation, DI
6. [docs/API_CONTRACT.md](docs/API_CONTRACT.md) — HTTP contract (update before Live APIs)
7. [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) — PR checklist
