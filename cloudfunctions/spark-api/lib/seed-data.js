...
function buildSeed() {
    ...
    [
      "act_002",
      {
        ...
        attendees: [
          ...
          { id: "u_like_3", display_name: "小晨", is_host: false, rsvp_status: "pending" },
        ],
      },
    ],
    [
      "act_smoke_host",
      {
        ...
        summary: "主办审核 · smoke",
        category: "活动",
        description: "Staging smoke: host review and co-host.",
        starts_at: "2026-06-12T09:00:00Z",
        location_name: "线上",
        host_display_name: "Staging User",
        host_id: "u_staging_1",
        attendee_count: 1,
        capacity: 10,
        waitlisted_count: 0,
        rsvp_status: "host",
        lifecycle_status: "scheduled",
        thread_id: "th_activity_act_smoke_host",
        attendees: [
          { id: "u_staging_1", display_name: "Staging User", is_host: true, rsvp_status: "host" },
          { id: "u_like_3", display_name: "小晨", is_host: false, rsvp_status: "pending" },
        ],
      },
    ],
  ...
  const likesState = {
    ...
    joined_communities_by_user: {
      u_staging_1: ["cm_hike", "cm_book", "cm_photo"],
    },
